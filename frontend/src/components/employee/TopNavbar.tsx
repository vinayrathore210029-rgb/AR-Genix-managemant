...
export default function TopNavbar({ title = "Workspace" }: { title?: string }) {
            ...
            <div className="flex items-center gap-4">
                <div className="relative w-full md:w-64 lg:w-96 group">
                    ...
                    <input
                        type="text"
                        placeholder="Search..."
                        className="w-full bg-[#121215]/80 backdrop-blur-md border border-white/5 rounded-2xl py-2.5 pl-12 pr-4 text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all shadow-lg"
                    />
                </div>
                ...
                <motion.div whileHover={{ scale: 1.02 }} className="flex items-center gap-3 cursor-pointer bg-[#121215]/80 border border-white/5 py-1.5 px-2 pr-4 rounded-full hover:bg-white/5 transition-all shadow-lg">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-emerald-500 to-teal-400 p-[2px]">
